      ...
      <div className="lg:w-5/6 px-8 py-8 bg-[#000] h-screen overflow-y-scroll hidescrollbar">
        ...
        <table className="table-fixed w-full border-seperate border-spacing-x-16 lg:border-spacing-x-40 border-slate-400">
          <thead className="h-[54px] lg:h-[62px]">
            <tr className="text-white border-spacing-x-3 border-b-[2px] border-[#1BFF3B] py-2 lg:py-8 pb-[40px]">
              <th>User Name</th>
              <th>Stocks</th>
              <th>Fiat</th>
            </tr>
          ...
          <tbody className="text-center">
            {userData.map((user) => (
              <tr className="text-white border-spacing-x-3 py-6 lg:py-8 pb-[40px] h-[54px] lg:h-[62px]">
                <td>{user.name}</td>
